...
if __name__ == "__main__":
    ...
    convert_xml(args.xsd_file, args.output_format, args.target_path, args.zip, args.xpath, args.multi, args.no_overwrite, args.verbose, args.log, args.delete_xml, args.input_files)